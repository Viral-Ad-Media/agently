  ...
  const faqs = [
    {
      ...
      answer: "Agently uses advanced AI to scan your website and extract key information about your services, pricing, and business hours. You can also manually add FAQ entries and specific instructions in the dashboard."
    },
    {
      question: "Can Agently handle complex customer questions?",
      answer: "Yes. Agently is powered by the latest Large Language Models, allowing it to understand context and provide nuanced answers. If a question is too complex, it can automatically escalate the call to a human team member."
    },
    {
    ...
    },
    {
      ...
      answer: "No. Agently is a cloud-based platform. You can use your existing phone number or we can provide a new one for you. All you need is an internet connection to manage your settings."
    },
    {
      question: "Can I customize the voice of my AI agent?",
      answer: "Yes. We offer a variety of high-quality, natural-sounding voice profiles. You can choose the one that best fits your brand's personality, from professional and authoritative to friendly and approachable."
    }
  ];
    ...
    <div className="min-h-screen bg-white font-inter pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <h2 className="text-xs font-black text-indigo-600 uppercase tracking-[0.3em] mb-4">Support Center</h2>
          <h1 className="text-5xl lg:text-7xl font-black text-slate-900 tracking-tight mb-8 leading-none">Got Questions? <br />We've Got Answers.</h1>
          <p className="text-xl text-slate-500 font-medium leading-relaxed">
            Everything you need to know about Agently and how it can transform your business communications.
          </p>
        </div>

        <div className="max-w-3xl mx-auto space-y-6">
          {faqs.map((faq, i) => (
            <div key={i} className="group rounded-[2.5rem] border-2 border-slate-50 bg-slate-50 hover:bg-white hover:border-indigo-100 transition-all duration-300 overflow-hidden">
              <button 
              ...
              >
                ...
                <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${openIndex === i ? 'bg-indigo-600 text-white rotate-45' : 'bg-white text-slate-400'}`}>
        ...
        <div className="mt-24 text-center p-12 rounded-[3rem] bg-slate-900 text-white relative overflow-hidden">
          ...
          <h3 className="text-3xl font-black mb-4 tracking-tight">Still have questions?</h3>
