...
const TONE_PREVIEWS = {
  Professional: "Greetings. I'm Maya, your dedicated receptionist. I'm here to ensure your inquiry is handled with the utmost efficiency and precision. How may I direct your call?",
  Friendly: "Hi there! I'm Maya. I'm so glad you called! I'd love to help you out with whatever you need today. What's on your mind?",
  Empathetic: "Hello, I'm Maya. I understand you're calling, and I'm here to listen and help in any way I can. We truly value your time. How are you doing today?"
};
...
const Onboarding: React.FC<OnboardingProps> = ({ onGenerateFaqs, onComplete }) => {
  ...
  const handleNext = async () => {
    ...
    try {
      if (step === 2) {
        ...
        setAgent(prev => ({ ...prev, faqs: generated.length > 0 ? generated : prev.faqs }));
        setStep(3);
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xs font-black uppercase tracking-[0.2em] text-indigo-400">Phase {step} of {TOTAL_STEPS}</h2>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 p-10 md:p-12 animate-in fade-in slide-in-from-bottom-8 duration-700 overflow-hidden relative">
          ...
          {step === 1 && (
            <div className="space-y-8">
              <div className="text-center md:text-left">
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">The Workplace</h1>
                <p className="text-slate-500 text-lg">Where will your new AI receptionist be "working"?</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Base City</label>
                  <input 
                    type="text" 
          ...
          {step === 2 && (
            <div className="space-y-8 text-center md:text-left">
              <div>
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Onboarding Data</h1>
                <p className="text-slate-500 text-lg">Point your agent to your website so they can learn your business "manual".</p>
              </div>
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Corporate Website</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-400 font-bold">https://</div>
                    <input 
                      type="text" 
                ...
                <div className="bg-indigo-50 p-6 rounded-[2rem] border border-indigo-100 flex items-start gap-4">
                  <div className="p-3 bg-indigo-600 rounded-2xl text-white shadow-lg shadow-indigo-100">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v8"/><path d="m16 6-4 4-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01"/><path d="M10 18h.01"/></svg>
                  </div>
                  <div>
                    <h4 className="text-sm font-black text-indigo-900 uppercase tracking-widest mb-1">Deep Analysis</h4>
                    <p className="text-sm text-indigo-700 leading-relaxed">Our AI will scan your site to understand your tone, services, and pricing so you don't have to write a single script.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-8">
              <div>
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Employee Handbook</h1>
                <p className="text-slate-500 text-lg">Review and edit the knowledge your agent has acquired.</p>
              </div>
              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-3 custom-scrollbar">
                {agent.faqs.map((faq, i) => (
                  <div key={faq.id} className="group p-6 rounded-[2rem] border-2 border-slate-50 bg-slate-50 hover:bg-white hover:border-indigo-100 transition-all relative">
              ...
              <button onClick={addFaqEntry} className="w-full py-4 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400 font-bold hover:bg-slate-50 hover:text-indigo-600 hover:border-indigo-300 transition-all">
          ...
          {step === 4 && (
            <div className="space-y-10">
              <div>
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Recruiting Persona</h1>
                <p className="text-slate-500 text-lg">How should your new hire sound to your customers?</p>
              </div>
              
              <div className="space-y-8">
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Office Name for Agent</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Select Voice Vibe</label>
                  <div className="grid grid-cols-3 gap-4">
                    {TONE_OPTIONS.map(t => (
                      ...
                      >
                        ...
                        <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest">{t.desc}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-indigo-600 p-6 rounded-[2rem] text-white shadow-2xl shadow-indigo-200 relative animate-in fade-in slide-in-from-top-4">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest opacity-70">How I'll sound</span>
                  </div>
                ...
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Typical Shift (Business Hours)</label>
          ...
          {step === 5 && (
            <div className="space-y-10">
              <div>
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Standard Procedures</h1>
                <p className="text-slate-500 text-lg">Define the protocols for transfers and data capture.</p>
              </div>

              <div className="space-y-8">
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Escalation Manager Number</label>
                  <input 
                    type="tel" 
                    ...
                    onChange={e => setAgent({...agent, escalationPhone: e.target.value})}
                  />
                </div>
                ...
                <div className="p-6 rounded-[2rem] bg-slate-50 border-2 border-slate-100 flex items-center justify-between group hover:border-indigo-200 transition-all">
                  <div>
                    <h4 className="font-black text-slate-900 flex items-center gap-2">
                       <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20v-6h4V8h-4V2"/><path d="m9 20 3-3-3-3"/></svg>
                       Voicemail Fallback
                    </h4>
                    <p className="text-xs text-slate-500">Record messages if transfer fails.</p>
                  </div>
                  <button 
                    onClick={() => setAgent({...agent, voicemailFallback: !agent.voicemailFallback})}
                  ...
                  >
                    <div className={`w-6 h-6 bg-white rounded-full transition-all shadow-md ${agent.voicemailFallback ? 'translate-x-6' : 'translate-x-0'}`}></div>
                  </button>
                </div>

                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Lead Capture Requirements</label>
            ...
            <div className="space-y-10 text-center">
              <div>
                <div className="w-24 h-24 bg-green-500 text-white rounded-[2.5rem] flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-green-100">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                </div>
                <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Recruitment Complete!</h1>
                <p className="text-slate-500 text-lg">Your agent is fully briefed and ready for their first call.</p>
              </div>
              ...
              <div className="bg-slate-50 p-10 rounded-[2.5rem] border-2 border-slate-100 space-y-6 text-left relative overflow-hidden">
                ...
                <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Selected Employee</span>
                  <span className="font-black text-slate-900">{agent.name} (Virtual Agent)</span>
                </div>
                <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Business HQ</span>
                  <span className="font-black text-slate-900">{profile.name}</span>
                </div>
                <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Shift Hours</span>
                  <span className="font-black text-slate-900">{hours.start} — {hours.end}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Communication Style</span>
                  <span className="font-black text-indigo-600">{agent.tone} Persona</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="mt-12 flex gap-4">
            ...
            >
              {loading ? (
                ...
                <>
                  <span>{step === TOTAL_STEPS ? 'Deploy to Office' : 'Next Step'}</span>
                  {step !== TOTAL_STEPS && (
        ...
        <div className="mt-10 flex items-center justify-center gap-8 opacity-40 grayscale group hover:grayscale-0 transition-all">
           <img src="https://upload.wikimedia.org/wikipedia/commons/b/b9/Stripe_Logo%2C_revised_2016.svg" alt="Stripe" className="h-5" />
